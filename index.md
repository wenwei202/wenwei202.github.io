...
[Up-to-date at Google Scholar](https://scholar.google.com/citations?user=JYD36ocAAAAJ&hl=en)

- W Zhang, L Wu, C Zhao, E Chang, M Zhuge, Z Liu, D Su, H Huang, J Chen, C Zhou, R Krishnamoorthi, V Chandra, M Elhoseiny, **W. Wen**, "dTRPO: Trajectory Reduction in Policy Optimization of Diffusion Large Language Models", **ICML**, 2026 \[[paper](https://arxiv.org/pdf/2603.18806)\] 
- C Zhu, S Suri, C Jose, M Oquab, M Szafraniec, **W. Wen**, Y Xiong, P Labatut, P Bojanowski, R Krishnamoorthi, V Chandra, “Efficient Universal Perception Encoder”, 2026, [[paper](https://arxiv.org/pdf/2603.22387)]
- J Fei, J Chen, Z Liu, Y Xiong, C Zhou, **W Wen**, J Han, M Zhuge, S Suri, Q Qian, S Liu, L Wu, R Krishnamoorthi, V Chandra, M Elhoseiny, C Zhu, “Small Vision-Language Models are Smart Compressors for Long Video Understanding”, **ECCV**, 2026, [[paper](https://arxiv.org/pdf/2604.08120)]
- S Liu, M Zhuge, C Zhao, J Chen, L Wu, Z Liu, C Zhu, Z Cai, C Zhou, H Liu, E Chang, S Suri, H Xu, Q Qian, **W. Wen**, B Varadarajan, Z Liu, H Xu, F Bordes, R Krishnamoorthi, B Ghanem, V Chandra, Y Xiong, “VideoAuto-R1: Video Auto Reasoning via Thinking Once, Answering Twice”, **CVPR**, 2026 [[paper](https://arxiv.org/pdf/2601.05175)]
- C. Zhao, E. Chang, Z. Liu, C.-J. Chang, **W. Wen**, C. Lai, S. Cao, Y. Tian, R. Krishnamoorthi, Y. Shi, V. Chandra, “MobileLLM-R1: Exploring the Limits of Sub-Billion Language Model Reasoners with Open Training Recipes”, **ICLR**, 2026 [[paper](https://arxiv.org/pdf/2509.24945)]
- P. Huber*, E. Chang*, **W. Wen***, I. Fedorov*, T. Elgamal, H. Huang, N. Suda, C. Sankar, V. Vogeti, Y. Wang, A. Gladkov, K. S. Tai, A. Elogeel, T. Hefny, V. Chandra, A. Aly, A. Kumar, R. Krishnamoorthi**, A. Sagar**, "MobileLLM-Pro Model Card", 2025 \[[HuggingFace](https://huggingface.co/facebook/MobileLLM-Pro)\]
- C. Zhao*, E. Chang*, Z. Liu*, C.-J. Chang, **W. Wen**, C. Lai, R. Cao, Y. Tian, R. Krishnamoorthi, Y. Shi, V. Chandra, "MobileLLM-R1: Exploring the Limits of Sub-Billion Language Model Reasoners with Open Training Recipes", preprint 2025 \[[paper](https://arxiv.org/pdf/2509.24945)\]
